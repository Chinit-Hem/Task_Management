...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Future<void> _pickAndSaveAvatar(UserSessionProvider sessionProvider) async {
    await sessionProvider.pickAndSaveProfileImage();
  }
                        ...
                        children: [
                          Stack(
                            children: [
                              GestureDetector(
                                onTap: _isEditing
                                    ? () => _pickAndSaveAvatar(sessionProvider)
                                    : null,
                                child: Hero(
                                  tag: 'profile_avatar',
                                  child: Container(
  ...
  Future<void> _saveProfile() async {
    try {
      ...
      final user = UserModel()
        ...
        ..avatarPath = sessionProvider.profileImagePath
      ...
      if (user != null && mounted) {
        setState(() {
          ...
          if (user.avatarPath != null && user.avatarPath!.isNotEmpty) {
            // Migrate old avatar to session provider if exists
            sessionProvider.updateProfile(profileImagePath: user.avatarPath);
          }
